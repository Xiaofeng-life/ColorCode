...
from methods.MyCECFPlus.data import ImageFilelist, ImageFolder
...
def write_metrics(path, epoch, ssim, psnr, uiqm):
    with open(path, mode='a') as f:
        info = str(epoch) + " " + str(ssim) + " " + str(psnr) + " " + str(uiqm) + "\n"
        f.write(info)
        f.close()
...
# def get_all_data_loaders(conf, real_hazy_train, real_hazy_val):
...
#
#     train_loader_real_hazy = get_data_loader_folder(real_hazy_train, batch_size, True,
#                                           new_size_a, height, width, num_workers, True)
#     train_loader_b = get_data_loader_folder(os.path.join(conf['data_root'], 'train/clear/'), batch_size, True,
#                                           new_size_b, height, width, num_workers, True)
#
#     test_loader_real_hazy = get_data_loader_folder(real_hazy_val, batch_size, False,
#                                          new_size_a, new_size_a, new_size_a, num_workers, True)
#     test_loader_b = get_data_loader_folder(os.path.join(conf['data_root'], 'val/clear/'), batch_size, False,
#                                          new_size_b, new_size_b, new_size_b, num_workers, True)
#
#     return train_loader_real_hazy, train_loader_b, test_loader_real_hazy, test_loader_b
